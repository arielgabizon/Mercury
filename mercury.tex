...
\[\halpha\defeq \gzeta \eqpol{u_1}(1/\zeta) + \ginv \eqpol{u_1}(\zeta) + \gamma(\hzeta \eqpol{u_2}(1/\zeta) + \hinv \eqpol{u_2}(\zeta))- \gamma v + \zeta \szeta + (1/\zeta)\sinv.\]
...
\item 
\[h(\alpha) =  g(\zeta) \eqpol{u_1}(1/\zeta) + g(1/\zeta)\eqpol{u_1}(\zeta) + \gamma(h(\zeta) \eqpol{u_2}(1/\zeta) + h(1/\zeta) \eqpol{u_2}(\zeta))- \gamma v + \zeta S(\zeta) + (1/\zeta)S(1/\zeta).\]
...
\[h(\alpha)+ \gamma v =  g(X) \eqpol{u_1}(1/X) + g(1/X)\eqpol{u_1}(X) + \gamma(h(X) \eqpol{u_2}(1/X) + h(1/X) \eqpol{u_2}(X))\]
\[  + X S(X) + (1/X)S(1/X).\]
...
Thus, we have
\[\mle{f}(u) = \sumj{b}\sumj{b}\eq(i,u_1)\eq(j,u_2) f_{i,j} = \sumj{b}\eq(j,u_2) \sumi{b}\eq(i,u_1) f_{i,j} \]
